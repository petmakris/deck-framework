(function () {
  ...
  function openDrawer()  { renderNotes(); drawer.classList.add('open'); drawerOpen = true; nbtn.classList.add('armed'); }
  function closeDrawer() { drawer.classList.remove('open'); drawerOpen = false; nbtn.classList.remove('armed'); }
